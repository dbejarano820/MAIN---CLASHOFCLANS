...
public class Creador extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        ArrayList<Guerreros> personajes = (ArrayList<Guerreros>) readObject("C:\\Users\\XT\\Documents\\personajes");
        ...
        if(tipo.equals("Contacto")){
            guerrerosContacto guerrero = new guerrerosContacto(vida,campos,imagen,nombre,daño,nivel,true);
            personajes.add(guerrero);
            writeObject(personajes, "C:\\Users\\XT\\Documents\\personajes");
            ...
            guerrerosAlcance guerrero = new guerrerosAlcance(vida,campos,imagen,nombre,daño,nivel,true);
            personajes.add(guerrero);
            writeObject(personajes, "C:/Users/XT/Documents/personajes.g");
        }
        else if(tipo.equals("Volador")){
            guerrerosAereos guerrero = new guerrerosAereos(vida,campos, imagen, nombre,daño,nivel,true);
            personajes.add(guerrero);
            writeObject(personajes, "C:/Users/XT/Documents/personajes.g");
        }
        else if(tipo.equals("Heroe")){
            guerrerosHeroes guerrero = new guerrerosHeroes(vida,campos,imagen,nombre,daño,nivel,true);
            personajes.add(guerrero);
            writeObject(personajes, "C:/Users/XT/Documents/personajes.g");
        }
        else if(tipo.equals("Bestia")){
            guerrerosBestias guerrero = new guerrerosBestias(vida,campos,imagen,nombre,daño,nivel,true);
            personajes.add(guerrero);
            writeObject(personajes, "C:/Users/XT/Documents/personajes.g");
        }
    ...
    private void btbBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btbBuscarActionPerformed
        ...
        fcCreador.showOpenDialog(this);
        this.ruta = fcCreador.getSelectedFile().getAbsolutePath();
